...
if(NOT EXISTS "${CROSS_COMPILE_CC}")
  ...
  elseif(EXISTS /usr/bin/aarch64-linux-gnu-gcc-6)
    ...
    message(FATAL_ERROR "NO COMPILER FOUND FOR AARCH64")
  endif()
endif()

if(NOT EXISTS "${CROSS_COMPILE_CC}" OR "${CROSS_COMPILE_CC}" STREQUAL "" OR NOT EXISTS "${CMAKE_SYSROOT}" OR "${CMAKE_SYSROOT}" STREQUAL "")
  message(FATAL_ERROR "NO COMPILER FOUND FOR AARCH64 OR NO SYSROOT")
endif()

SET(CMAKE_CROSS_PREFIX ${CROSS_COMPILE})
